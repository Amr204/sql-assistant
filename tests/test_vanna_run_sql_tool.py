"""Primary Vanna SQL tool is registered as ``run_sql``."""
...
@pytest.mark.asyncio
async def test_sql_tool_name_is_run_sql(tmp_path) -> None:
    ...
    settings = Settings(  # type: ignore[call-arg]
        ...
        llm_provider="none",
        chroma_persist_dir=str(tmp_path / "r"),
        _env_file=None,
    )
    mem, _ = create_memory(
        profile_id="sample",
        persist_dir=tmp_path / "r",
